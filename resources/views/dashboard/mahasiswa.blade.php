...
@section('content')
    <div class="flex justify-between items-center mb-4 dark:text-gray-100">
    ...
    <div class="bg-gradient-to-r from-purple-500 to-purple-700 p-6 rounded-lg shadow-lg mb-8">
        <h2 class="text-2xl font-bold text-white">Selamat Datang, Mahasiswa!</h2>
        <p class="text-sm text-purple-200">Anda telah masuk ke dashboard Mahasiswa. Selamat bekerja dan semoga hari Anda menyenangkan!</p>
    </div>
        ...
        <ul>
            @foreach ($bimbingans as $skripsiItem)
                <li class="mb-6 p-4 bg-gray-700 rounded-lg shadow">
                    ...
                    <p class="mt-2">Status: 
                        <span class="font-medium {{ $skripsiItem->status_bimbingan === 'berjalan' ? 'text-yellow-400' : 'text-green-400' }}">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="mb-6">
                            <div class="w-full bg-gray-700 rounded-full h-4 relative">
                                <div class="bg-gradient-to-r from-blue-500 to-blue-700 h-4 rounded-full" style="width: {{ $progress }}%;"></div>
