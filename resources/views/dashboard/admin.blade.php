...
@section('content')
    ...
    <div class="bg-gradient-to-r from-purple-600 to-purple-800 p-6 rounded-lg shadow-lg mb-8">
        <h2 class="text-2xl font-bold text-white">Selamat Datang, Admin!</h2>
        <p class="text-sm text-purple-200">Anda telah masuk ke dashboard admin. Selamat bekerja dan semoga hari Anda
            menyenangkan!</p>
    </div>
    <!-- Statistik -->
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <!-- Skripsi -->
        <div class="bg-gradient-to-r from-yellow-600 to-yellow-800 p-6 rounded-lg shadow-lg">
