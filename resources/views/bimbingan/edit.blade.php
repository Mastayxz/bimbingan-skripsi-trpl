...
<form action="{{ route('penilaian.update', ['id_bimbingan' => $bimbingan->id_bimbingan, 'id' => $penilaian->id]) }}" method="POST" enctype="multipart/form-data" class="max-w-lg ">
    @csrf
    @method('PUT')
    ...
    <div class="mb-4">
        ...
        <div class="flex items-center">
            ...
            <input 
                ...
                id="{{ $field }}" 
                name="{{ $field }}" 
                value="{{ old($field, $penilaian->$field ?? 0) }}" 
                max="100" 
