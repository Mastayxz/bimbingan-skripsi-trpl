...
<div class="container mx-auto px-4 py-6">
    <h1 class="text-3xl font-semibold mb-6">Daftar Skripsi Lulus Ujian</h1>
                ...
                <tr class="border-b hover:bg-gray-50">
                    ...
                    {{-- <td class="px-4 py-3 text-center">
                        ...
                        <span class="inline-block py-1 px-3 text-sm font-semibold rounded-full 
                            @if($item->status == 'selesai') bg-green-200 text-green-800 
                            @elseif($item->status == 'berjalan') bg-blue-200 text-blue-800 
                    ...
                    <td>
                        <a href="{{ route('admin.skripsi.edit', $item->id_skripsi) }}" 
                           class="inline-block py-2 px-4 bg-blue-500 text-white text-center text-sm rounded hover:bg-blue-600">
                           Set Pembimbing 2
                        </a>
                    </td>
                </tr>
